...
module.exports = {
    ...
    build: function build() {
        ...
        // set the element
        self.draw = (0, _svg2.default)(self.id);
...
},{"./time-spent":32,"lodash/forEach":16}],32:[function(require,module,exports){
'use strict';
